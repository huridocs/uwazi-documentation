...
Step 2: Within the right sidebar, click on the **Connections** icon ![](images/image_57.png) to open up the **Information Hub**. Then near the bottom of the screen, click on the blue **Edit** button.
...
Step 2: Within the right sidebar menu, click on the **Connections** icon![](images/image_57.png) to open up the **Information Hub**.
