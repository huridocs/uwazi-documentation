...
Remember, before you can create a new entity, make sure you have already created a corresponding template. Learn more about how to create templates. To create a new entity:
...
Step 3: Using the **Type** drop-down menu, select which entity template you would like to use for the new entity. If you need to create a new template, refer to the instructions for doing so in the previous chapter.
